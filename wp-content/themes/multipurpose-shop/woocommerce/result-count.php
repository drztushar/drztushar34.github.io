 ...
 */
$link = apply_filters( 'multipurpose_num_products_link', $link );
...
<ul class="result-count">
    <li class="view-title"><?php esc_html_e( 'View:', 'multipurpose-shop' ) ?></li>
    ...
    <li><a class="view-all <?php if ( $num_prod == 'all' ) echo esc_attr( 'active' ); ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link  ) ) ?>"><?php esc_html_e( 'All', 'multipurpose-shop' ) ?></a></li>
</ul>
